...
public interface TestService {
    ...
    String deleteTest(TestDto TestDto) throws ServiceException;//这个是从数据库里面删除

    String cancelTest(Integer testId) throws ServiceException;//这个是把考试设置成取消状态（正在进行中和已完成的考试不得取消）
    ...
    String endTest(Integer testId) throws ServiceException;//立即停止考试（要求该考试在进行中）
}
